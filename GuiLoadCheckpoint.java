...
public class GuiLoadCheckpoint extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        back = new GuiButton(-1, width / 2 - 30, height / 4 + 24 + byte0, "Back");
        prev = new GuiButton(-2, width / 2 - 30 - 60 - 2, height / 4 + 24 + byte0, "<<<");
        next = new GuiButton(-3, width / 2 + 30 + 2, height / 4 + 24 + byte0, ">>>");
        
        back.width = prev.width = next.width = 60;
		...
		for(File file : files){
			...
			GuiButton delbtn = new GuiButton(index+1000, width / 2 + 100 + 4, height / 4 + 24*2 + 6 + 23*pagecounter + byte0, "X");
			delbtn.width = 20;
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if(guiSubTitle == null || (gameOverScreen && mc.theWorld.worldInfo.isHardcoreModeEnabled())){
