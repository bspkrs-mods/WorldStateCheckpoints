...
public class GuiLoadCheckpoint extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (guiSubTitle == null || (gameOverScreen && WSCSettings.mc.theWorld.getWorldInfo().isHardcoreModeEnabled()))
            drawCenteredString(fontRendererObj, guiTitle, width / 2, 50 + 5, 0xffffff);
        else
        {
            drawCenteredString(fontRendererObj, guiSubTitle, width / 2, 50 + 5, 0xee0000);
            drawCenteredString(fontRendererObj, guiTitle, width / 2, 50 + 5 - 16, 0xffffff);
        }
